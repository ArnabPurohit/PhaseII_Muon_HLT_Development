...
muonTrackValidator = DQMEDAnalyzer("MuonTrackValidator",
    ...
    #label_pileupinfo = cms.InputTag("addPileupInfo","","HLT"), ### federica 2.06.2020
    #
    # input reco::Track collection
    label = cms.VInputTag(cms.InputTag("globalMuons")),
    beamSpot = cms.InputTag("offlineBeamSpot"),
    #beamSpot = cms.InputTag('hltOnlineBeamSpot','','HLT'), ### federica 2.06.2020
    #
...
phase2_muon.toModify( muonTrackValidator, beamSpot = cms.InputTag('hltOnlineBeamSpot','','HLT'))
