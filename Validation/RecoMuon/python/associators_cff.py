...
#uncomment to take only muons from IO_L2seeded
#tpToL3TkMuonAssociation.tracksTag = 'hltIter2IterL3MuonMerged'
...
#uncomment to take only muons from IO_L1seeded
#tpToL3FromL1TkMuonAssociation.tracksTag = 'hltIter2IterL3FromL1MuonMerged'
